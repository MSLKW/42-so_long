...
BONUS_SRCS_FILES := so_long_bonus.c graphics_bonus.c graphics2_bonus.c map_bonus.c map_validator_bonus.c map_validator2_bonus.c map_validator3_bonus.c map_utils_bonus.c movement_manager_bonus.c enemy_utils_bonus.c animation_manager_bonus.c free_data_bonus.c
...
bonus: $(BONUS_OBJS) $(BONUS_DEPS) $(LIBFT) $(LIBMLX)
	$(CC) $(CFLAGS) $(BONUS_OBJS) $(LIBFT) $(LIBMLX) $(EFLAGS) -o $(NAME)	
